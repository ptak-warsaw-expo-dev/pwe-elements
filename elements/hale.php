    ...
    public static function initElements() {
        $element_output = array(
            array(
                'type' => 'textfield',
                'group' => 'PWE Element',
                'heading' => __('Halls', 'pwelement'),
                'param_name' => 'hall_names',
                'save_always' => true,
                'dependency' => array(
                    'element' => 'pwe_element',
                    'value' => 'PWElementHale',
            ...
            array(
                'type' => 'attach_image',
                'group' => 'PWE Element',
                'heading' => __('Hall image', 'pwelement'),
                'param_name' => 'hall_image',
                'save_always' => true,
                'dependency' => array(
                    'element' => 'pwe_element',
                    'value' => 'PWElementHale',
    ...
    public static function output($atts) {
        ...
        if (!empty($all_halls)) {
            ...
            <style>
                ...
                .pwe-halls__information {
                    margin-top: 18px;
                }
                .pwe-halls__information p {
                    margin-top: 0px;
                    font-size: 18px;
                            ...
                            <g id="A1_A2" class="pwe-halls__element half">
                                <g id="A1" class="pwe-halls__element quarter">
                                    ...
                                    <g id="numer_hali_A" class="st9">
                                        <g class="st9">
                                            <g class="st9">
                                                <text class="st8" transform="translate(733.7 1084.8)"><tspan x="-16" y="14">A</tspan></text>
                                            </g>
                                        </g>
                                    </g>
                                </g>
