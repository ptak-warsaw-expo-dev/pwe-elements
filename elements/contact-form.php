...
class PWElementContactForm extends PWElements
{
    ...
    public static function output($atts)
    {
        ...
        if (class_exists('GFAPI') && !function_exists('get_form_id_by_title')) {
            ...
            <script>
                ...
                if (departmentField) {
                    ...
                    radioLabels.forEach(label => {
                        ...
                        switch (text) {
                            case "Exhibitors":
                                label.textContent = "' . self::multi_translation("exhibitors") . '";
                                break;
                            case "Visitors":
                                label.textContent = "' . self::multi_translation("visitors") . '";
                                break;
                            case "Technical Department":
                                label.textContent = "' . self::multi_translation("technical_department") . '";
                                break;
                            case "Marketing":
                                label.textContent = "' . self::multi_translation("marketing") . '";
                                break;
                        }
                    });
                }
