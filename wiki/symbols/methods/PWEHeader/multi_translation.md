# `PWEHeader::multi_translation()`

**Źródło:** `includes/header/header.php:36`  
**Sygnatura:** `public static multi_translation($key)`

## Kontekst

- Klasa: [`PWEHeader`](../../classes/PWEHeader.md)
- Plik: [dokument pliku](../../../files/includes/header/header.php.md)
