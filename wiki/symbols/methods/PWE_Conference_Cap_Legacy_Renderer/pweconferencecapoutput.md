# `PWE_Conference_Cap_Legacy_Renderer::PWEConferenceCapOutput()`

**Źródło:** `includes/conference-cap/core/legacy-shortcode-renderer.php:206`  
**Sygnatura:** `public static PWEConferenceCapOutput($atts)`

## Kontekst

- Klasa: [`PWE_Conference_Cap_Legacy_Renderer`](../../classes/PWE_Conference_Cap_Legacy_Renderer.md)
- Plik: [dokument pliku](../../../files/includes/conference-cap/core/legacy-shortcode-renderer.php.md)
