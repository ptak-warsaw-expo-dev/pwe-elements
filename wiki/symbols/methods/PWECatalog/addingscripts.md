# `PWECatalog::addingScripts()`

**Źródło:** `includes/katalog-wystawcow/main-katalog-wystawcow.php:63`  
**Sygnatura:** `addingScripts($atts)`

## Kontekst

- Klasa: [`PWECatalog`](../../classes/PWECatalog.md)
- Plik: [dokument pliku](../../../files/includes/katalog-wystawcow/main-katalog-wystawcow.php.md)
