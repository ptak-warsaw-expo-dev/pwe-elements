# `PWEExhibitorGenerator::catalog_data()`

**Źródło:** `includes/exhibitor-generator/exhibitor-generator.php:254`  
**Sygnatura:** `public static catalog_data($exhibitor_id = null)`
