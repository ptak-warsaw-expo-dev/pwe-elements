# `PWEExhibitorGenerator::PWEExhibitorGeneratorOutput()`

**Źródło:** `includes/exhibitor-generator/exhibitor-generator.php:336`  
**Sygnatura:** `public PWEExhibitorGeneratorOutput($atts)`
