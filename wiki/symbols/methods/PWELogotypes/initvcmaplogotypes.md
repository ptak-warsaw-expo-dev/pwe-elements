# `PWELogotypes::initVCMapLogotypes()`

**Źródło:** `includes/logotypes/logotypes.php:32`  
**Sygnatura:** `public initVCMapLogotypes()`

## Kontekst

- Klasa: [`PWELogotypes`](../../classes/PWELogotypes.md)
- Plik: [dokument pliku](../../../files/includes/logotypes/logotypes.php.md)
