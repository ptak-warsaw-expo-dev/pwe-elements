# `PWEConferenceShortInfo::PWEConferenceShortInfoOutput()`

**Źródło:** `includes/conference-short-info/conference-short-info.php:83`  
**Sygnatura:** `public PWEConferenceShortInfoOutput($atts)`
