# `PWEConferenceShortInfo::initVCMapPWEConferenceShortInfo()`

**Źródło:** `includes/conference-short-info/conference-short-info.php:42`  
**Sygnatura:** `public initVCMapPWEConferenceShortInfo()`

## Kontekst

- Klasa: [`PWEConferenceShortInfo`](../../classes/PWEConferenceShortInfo.md)
- Plik: [dokument pliku](../../../files/includes/conference-short-info/conference-short-info.php.md)
