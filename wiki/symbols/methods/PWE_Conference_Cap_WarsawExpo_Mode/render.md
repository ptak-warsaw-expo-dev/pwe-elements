# `PWE_Conference_Cap_WarsawExpo_Mode::render()`

**Źródło:** `includes/conference-cap/modes/warsawexpo/warsawexpo.php:328`  
**Sygnatura:** `public render(array $context)`

## Kontekst

- Klasa: [`PWE_Conference_Cap_WarsawExpo_Mode`](../../classes/PWE_Conference_Cap_WarsawExpo_Mode.md)
