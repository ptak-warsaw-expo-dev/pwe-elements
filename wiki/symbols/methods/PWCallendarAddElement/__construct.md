# `PWCallendarAddElement::__construct()`

**Źródło:** `elements/calendarAdd.php:12`  
**Sygnatura:** `public __construct()`

## Kontekst

- Klasa: [`PWCallendarAddElement`](../../classes/PWCallendarAddElement.md)
- Plik: [dokument pliku](../../../files/elements/calendarAdd.php.md)
