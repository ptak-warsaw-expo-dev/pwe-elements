# `PWElementXForm::confirmNoHtml()`

**Źródło:** `elements/x_step_registration.php:1556`  
**Sygnatura:** `public static confirmNoHtml($atts, $reg_form_id,  $conf_form_id, $text_color, $go_back_url)`
