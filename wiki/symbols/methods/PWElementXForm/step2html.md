# `PWElementXForm::step2Html()`

**Źródło:** `elements/x_step_registration.php:1019`  
**Sygnatura:** `public static step2Html($reg_form_id, $confirmation_url, $text_color, $fair_logo, $go_back_url)`
