# `PWElementXForm::exhibitor_registering()`

**Źródło:** `elements/x_step_registration.php:329`  
**Sygnatura:** `public static exhibitor_registering($entry_id, $exhibitor, $update = '')`
