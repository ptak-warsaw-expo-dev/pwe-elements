# `PWElementOtherEvents::is_excluded_domain()`

**Źródło:** `elements/other_events.php:221`  
**Sygnatura:** `private static is_excluded_domain(string $domain, array $excluded)`

## Kontekst

- Klasa: [`PWElementOtherEvents`](../../classes/PWElementOtherEvents.md)
- Plik: [dokument pliku](../../../files/elements/other_events.php.md)
