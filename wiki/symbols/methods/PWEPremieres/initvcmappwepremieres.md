# `PWEPremieres::initVCMapPWEPremieres()`

**Źródło:** `includes/premieres/premieres.php:20`  
**Sygnatura:** `public initVCMapPWEPremieres()`

## Kontekst

- Klasa: [`PWEPremieres`](../../classes/PWEPremieres.md)
- Plik: [dokument pliku](../../../files/includes/premieres/premieres.php.md)
