# `PWElementDontMiss::output()`

**Źródło:** `elements/niePrzegap.php:24`  
**Sygnatura:** `public static output($atts)`

## Kontekst

- Klasa: [`PWElementDontMiss`](../../classes/PWElementDontMiss.md)
- Plik: [dokument pliku](../../../files/elements/niePrzegap.php.md)
