# `PWElementOpinions::getLangField()`

**Źródło:** `elements/opinions.php:230`  
**Sygnatura:** `public static getLangField(array $item, string $baseKey)`

## Kontekst

- Klasa: [`PWElementOpinions`](../../classes/PWElementOpinions.md)
- Plik: [dokument pliku](../../../files/elements/opinions.php.md)
