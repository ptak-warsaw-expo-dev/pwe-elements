# `PWECalendar::multi_translation()`

**Źródło:** `includes/calendar/classes/loop-calendar.php:181`  
**Sygnatura:** `multi_translation($key)`

## Kontekst

- Klasa: [`PWECalendar`](../../classes/PWECalendar.md)
- Plik: [dokument pliku](../../../files/includes/calendar/classes/loop-calendar.php.md)
