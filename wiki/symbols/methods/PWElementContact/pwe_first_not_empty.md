# `PWElementContact::pwe_first_not_empty()`

**Źródło:** `elements/kontakt.php:73`  
**Sygnatura:** `private static pwe_first_not_empty($manual_value, $default_value = '')`

## Kontekst

- Klasa: [`PWElementContact`](../../classes/PWElementContact.md)
- Plik: [dokument pliku](../../../files/elements/kontakt.php.md)
