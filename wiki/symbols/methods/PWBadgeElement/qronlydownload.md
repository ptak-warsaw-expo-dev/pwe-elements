# `PWBadgeElement::qrOnlyDownload()`

**Źródło:** `elements/badge-local.php:179`  
**Sygnatura:** `public static qrOnlyDownload($badge_form_id)`

## Kontekst

- Klasa: [`PWBadgeElement`](../../classes/PWBadgeElement.md)
- Plik: [dokument pliku](../../../files/elements/badge-local.php.md)
