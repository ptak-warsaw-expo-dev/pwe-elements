# `PWENews::initVCMapPWENews()`

**Źródło:** `includes/news/news.php:19`  
**Sygnatura:** `public initVCMapPWENews()`

## Kontekst

- Klasa: [`PWENews`](../../classes/PWENews.md)
- Plik: [dokument pliku](../../../files/includes/news/news.php.md)
