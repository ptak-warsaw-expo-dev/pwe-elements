# `PWEStore::initVCMapPWEStore()`

**Źródło:** `includes/store/store.php:20`  
**Sygnatura:** `public initVCMapPWEStore()`

## Kontekst

- Klasa: [`PWEStore`](../../classes/PWEStore.md)
- Plik: [dokument pliku](../../../files/includes/store/store.php.md)
