# `PWEMailing::cleanup_catalog_feedback_entries()`

**Źródło:** `includes/mailing/mailing.php:247`  
**Sygnatura:** `public cleanup_catalog_feedback_entries()`

## Kontekst

- Klasa: [`PWEMailing`](../../classes/PWEMailing.md)
- Plik: [dokument pliku](../../../files/includes/mailing/mailing.php.md)
