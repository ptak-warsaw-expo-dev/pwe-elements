# `PWEConferenceCapWarsawExpo::parse_date_to_standard()`

**Źródło:** `includes/conference-cap/modes/warsawexpo/warsawexpo.php:6`  
**Sygnatura:** `private static parse_date_to_standard($input)`

## Kontekst

- Klasa: [`PWEConferenceCapWarsawExpo`](../../classes/PWEConferenceCapWarsawExpo.md)
- Plik: [dokument pliku](../../../files/includes/conference-cap/modes/warsawexpo/warsawexpo.php.md)
