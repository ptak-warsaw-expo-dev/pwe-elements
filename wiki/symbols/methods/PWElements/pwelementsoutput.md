# `PWElements::PWElementsOutput()`

**Źródło:** `elements/pwelements-options.php:775`  
**Sygnatura:** `public PWElementsOutput($atts, $content = null)`

## Kontekst

- Klasa: [`PWElements`](../../classes/PWElements.md)
- Plik: [dokument pliku](../../../files/elements/pwelements-options.php.md)
