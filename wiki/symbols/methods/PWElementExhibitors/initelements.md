# `PWElementExhibitors::initElements()`

**Źródło:** `elements/exhibitors-benefits.php:43`  
**Sygnatura:** `public static initElements()`

## Kontekst

- Klasa: [`PWElementExhibitors`](../../classes/PWElementExhibitors.md)
- Plik: [dokument pliku](../../../files/elements/exhibitors-benefits.php.md)
