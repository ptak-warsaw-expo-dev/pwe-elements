# `PWEProfile::PWEProfileOutput()`

**Źródło:** `includes/profile/profile.php:201`  
**Sygnatura:** `public PWEProfileOutput($atts, $content = null)`

## Kontekst

- Klasa: [`PWEProfile`](../../classes/PWEProfile.md)
- Plik: [dokument pliku](../../../files/includes/profile/profile.php.md)
