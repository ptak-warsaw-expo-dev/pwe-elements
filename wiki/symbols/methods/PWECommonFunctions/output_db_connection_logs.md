# `PWECommonFunctions::output_db_connection_logs()`

**Źródło:** `pwefunctions.php:89`  
**Sygnatura:** `public static output_db_connection_logs()`

## Kontekst

- Klasa: [`PWECommonFunctions`](../../classes/PWECommonFunctions.md)
- Plik: [dokument pliku](../../../files/pwefunctions.php.md)
