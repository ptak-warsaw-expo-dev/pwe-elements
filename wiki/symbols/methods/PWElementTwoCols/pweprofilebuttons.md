# `PWElementTwoCols::pweProfileButtons()`

**Źródło:** `elements/two_cols.php:21`  
**Sygnatura:** `public pweProfileButtons()`

## Kontekst

- Klasa: [`PWElementTwoCols`](../../classes/PWElementTwoCols.md)
- Plik: [dokument pliku](../../../files/elements/two_cols.php.md)
