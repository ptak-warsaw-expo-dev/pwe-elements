# `get_database_fairs_data_attractions()`

**Źródło:** `pwefunctions.php:3313`  
**Sygnatura:** `get_database_fairs_data_attractions($fair_domain = null)`
...
- [Otwórz dokument pliku](../../files/pwefunctions.php.md)
