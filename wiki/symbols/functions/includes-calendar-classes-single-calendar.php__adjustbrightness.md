...
**Źródło:** `includes/calendar/classes/single-calendar.php:20`  
**Sygnatura:** `adjustBrightness($hex, $steps)`
...
- [Otwórz dokument pliku](../../files/includes/calendar/classes/single-calendar.php.md)
