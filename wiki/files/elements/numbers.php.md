...
- **Rozmiar:** 27920 B
- **Liczba linii:** 656
- **Źródło:** `elements/numbers.php`

## Klasy i metody

### `PWElementNumbers` — linia 7

  - `public __construct()` — linia 13
  - `public static initElements()` — linia 21
  - `public static multi_translation($key)` — linia 149
  - `public static output($atts)` — linia 168
