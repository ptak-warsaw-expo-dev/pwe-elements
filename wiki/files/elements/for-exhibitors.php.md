...
- **Rozmiar:** 11893 B
- **Liczba linii:** 251
- **Źródło:** `elements/for-exhibitors.php`

## Klasy i metody

### `PWElementForExhibitors` — linia 6

  - `public __construct()` — linia 12
  - `public static initElements()` — linia 20
  - `public static multi_translation($key)` — linia 39
  - `public static output($atts, $content = '')` — linia 64
