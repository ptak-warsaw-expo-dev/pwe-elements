...
$api_url = 'https://'. $domain .'/wp-content/plugins/custom-element/api/pwe_api.php';
...
if (!empty($api_media["doc"])) {
    ...
    foreach ($api_media["doc"] as $file) {
        ...
        // Attractions search
        if (strpos($file['path'], 'doc/attractions.webp') !== false) {
            $attractions_image = $file['path'];
        }
    }
}
...
if ($event_type === "week") {
    ...
    $visitors_num = array_sum($unique_visitors);
    $exhibitors_num = array_sum($unique_exhibitors);
    $area_num = array_sum($unique_area);
    ...
    $area_num = min((int) preg_replace('/[^\d]/', '', (string) $area_num), 153000);
    ...
    while (have_posts()):
        ...
        $title = mb_strtolower(str_replace(' ', '-', $title), 'UTF-8');
                ...
                <div class="single-event__wrapper">';
                    ...
                    <div class="single-event__main-content">
                        ...
                        if (!empty($events_week_halls_image_url)) {
                            ...
                            <div id="singleEventHalls" class="single-event__halls" data-all-items='. json_encode($json_data_all) .'>
                                <div class="single-event__description-wrapper">
                                    <div class="single-event__description-title">
                                        <h3>'. get_the_title() .'</h3>
                                    </div>
                                ...
                                require_once plugin_dir_path(dirname(__FILE__)) . 'assets/svg.php';
                    ...
                    <div id="singleEventExhibitors" class="single-event__exhibitors">';
                        ...
                        if (!empty($catalog_ids)) {
                            ...
                            $output .= do_shortcode('[pwe-elements-auto-switch-exhibitor-catalog archive_catalog_id="'. $catalog_ids .'"]');
                        } else {
                            $output .= '
                            <div id="singleEventCatalogHeader" class="single-event__catalog-header">
                                <div class="single-event__catalog-header-wrapper">
                        ...
                        <div class="single-event__container-tiles">
                            ...
                            <div class="single-event__tiles-right-container">
                                ...
                                <div class="single-event__tiles-right-bottom">';
                                    ...
                                    if (!empty(get_post_meta($post_id, 'buy_ticket_link', true)) && !empty($attractions_image)) {
                                        $output .= '
