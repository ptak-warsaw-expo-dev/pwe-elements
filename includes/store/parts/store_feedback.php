...
<div class="store-feedback">
    <svg fill="var(--accent-color)" viewBox="4 4 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier"> 
            <g data-name="Layer 2"> 
                <g data-name="arrow-up"> 
                    ...
                    <path d="M16.21 16H7.79a1.76 1.76 0 0 1-1.59-1 2.1 2.1 0 0 1 .26-2.21l4.21-5.1a1.76 1.76 0 0 1 2.66 0l4.21 5.1A2.1 2.1 0 0 1 17.8 15a1.76 1.76 0 0 1-1.59 1z"></path> 
                </g> 
            </g> 
        </g>
    </svg>
    <h3>'. (self::lang_pl() ? 'Jak oceniasz sklep?' : 'How do you rate the store?') .'</h3>
    '. $form_html .'
    <p class="rating-hint">'. (self::lang_pl() ? 'Twoja opinia jest anonimowa' : 'Your opinion is anonymous') .'</p>
</div>';
