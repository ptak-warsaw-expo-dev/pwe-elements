...
if (
    ...
    } else if (strpos($source_utm, 'utm_source=premium') !== false || (strpos($source_utm, 'utm_source=platyna') !== false && ($domain_gr !== "gr2" || $domain_gr !== "gr3")) ) {
        $output .= '
        <style>
            #pweRegistration input[type="submit"] {
    ...
    if (strpos($source_utm, 'utm_source=byli') !== false || strpos($source_utm, 'utm_source=premium') !== false || (strpos($source_utm, 'utm_source=platyna') !== false && ($domain_gr !== "gr2"|| $domain_gr !== "gr3"))) {
        $output .= '
        <style>
        ...
        <style>
            ...
            .gform_wrapper::after {
                ...
                background-color: rgba(232, 232, 232, 0.81) !important;
                border-radius: 8px;
            ...
            .gform_wrapper::before {
                ...
                border: 8px solid #d1d1d1 !important;
                border-top: 8px solid var(--accent-color) !important;
                border-radius: 50% !important;
                animation: gform_custom_spin 0.8s linear infinite !important;
                z-index: 9999 !important;
            }

            @keyframes gform_custom_spin {
                0% { transform: rotate(0deg); }
                100% { transform: rotate(360deg); }
            }

            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(.gform_ajax_spinner)::after,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(.gform-loader)::after,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(gform-loader)::after,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has([data-gform-loader])::after {
                display: block !important;
            }

            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(.gform_ajax_spinner)::before,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(.gform-loader)::before,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has(gform-loader)::before,
            .gform_wrapper:not(.gform_validation_error):not(:has(.gfield_error)):has([data-gform-loader])::before {
                display: block !important;
            }
            ...
            .gform_wrapper.gform_validation_error::after,
            .gform_wrapper.gform_validation_error::before,
            .gform_wrapper:has(.gfield_error)::after,
            .gform_wrapper:has(.gfield_error)::before {
                display: none !important;
            }
...
if(strpos($source_utm, 'utm_source=platyna') !== false && ($domain_gr=="gr2" || $domain_gr=="gr3")){
